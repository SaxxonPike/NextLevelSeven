...
{
    /// <summary>Specification-specific extensions to the IElement interface.</summary>
    public static class ElementSpecificationExtensions
    {
        /// <summary>Get the element expressed as an HL7 address type. (AD)</summary>
        ...
        /// <summary>Get the element expressed as an HL7 coded element type. (CE)</summary>
        /// <param name="element">Element to interpret.</param>
        ...
        /// <summary>Get the element expressed as an HL7 number range type. (NR)</summary>
        /// <param name="element">Element to interpret.</param>
