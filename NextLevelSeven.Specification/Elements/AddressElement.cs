...
namespace NextLevelSeven.Specification.Elements
{
    ...
    {
        public AddressElement(IElement element)
            : base(element)
        {
        }
        ...
        public AddressType AddressType
        {
            get
            {
                return AddressTypeConverter.ConvertToTable(Element[7].Value);
            }
            set
            {
                Element[7].Value = AddressTypeConverter.ConvertFromTable(value);
            }
        }
