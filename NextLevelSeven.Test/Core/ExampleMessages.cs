...
namespace NextLevelSeven.Test.Core
{
    ...
    {
        static public readonly string A04 = @"MSH|^~\&|||||20120731102052||ADT^A04|20731172052000155374|P|2.2|18
EVN|A04|20120731102052|||dtrn1
PID|||000913545||UPDATEDISCHN^OPTWO^R||19410115|M|||888 2ND AVE^^LOSANGELES^CA^90045||(310)564-6546|||M|AT|155374|949-84-9494
PV1||O|OQA|3|20||890|||MED||||1|||890|O||||||||||||||||||||||||||20101028|0500
PV2|||PAIN|||||20101028
GT1|UPDATEDISCHN^OPTWO^||||888 2ND AVE^^LOS ANGELES^CA^90045|(310)564-6546|||||S |949-84-9494|||||||
IN1|1|MO|||MEDICARE A   B|MEDICARE A   B|MUTUAL OF OMAHA^BOX 1602-MEDICARE  DEPT^OMAHA^NEBRASKA^92668|429785381|(402)9785381||||||||^^||MO||||||0.00|0||||101028|dtr|||||||1|1||""||""||||Y|";

        static public readonly string BadSubComponent = @"MSH|^~\&|MIC|P1SDEV|||201310091028||ORU^R01|1424734.1|P|2.3
...
OBR|1|542354^PCM|5432543^LA01|1048^CULTURE WOUND^LA01^1048^CULTURE WOUND^LA01|1||201409081255|||305518||||201409081506|144&Wound^^^^^CON&CONTAINER|74423^FRASER*^NIKKAYA^M|(260)434-6214^9,4346496&&&&&&&&NOTE^NOTE^&&&&&&&&NOTE|||||201409111054||MIC|F||1^^^201409081255^^1|74423^FRASER*^NIKKAYA^M|||||||||||^^^^1";
        ...
        public static readonly string MultipleObr = @"MSH|^~\&|LabPak|LABRESULTS|ICA|LAB|201003150118||ORU^R01|5101|P|2.3|||NE|NE|
PID|1|1034157|012993817||LASTNAME^FIRSTNAME||19520101|M|||1234 MAIN^^DEARBORN HEIGHT^MI^48127||||||||
PV1|1|R|||||||||||||||||
...
OBX|1|NM|LPBN^NT-PRO BNP^L||2003.2|pg/ml|0.0-125.0|H|||F|||||RA";
        ...
        static public readonly string MultiplePid = @"MSH|^~\&|SOURCE|383018129|PRIORITY HEALTH|382715520|2007100914484648||ORU^R01|0129938170710091448|P|2.3|
PID|1|1034157|012993817||LASTNAME^FIRSTNAME||19520101|M|||1234 MAIN^^DEARBORN HEIGHT^MI^48127||||||||
...
OBX|4|NM|2571-8^TRIGLYCERIDES^LOINC|324.000|MG/DL| 0.000 - 150.000|H|||F|";
        ...
        static public readonly string RepeatingName = @"MSH|^~\&||P1SDEV|||20140522103041||ADT^A60||P||
PID|1|SSD0201941|SA0062046||Lincoln^Abe~Bro~Dude||19231214|M||C|^Some Rd.^Somewhere^IL^68763|||||M||SA0003176321|000-00-0000
PV1|||SA.OPS";

        static public readonly string Standard = @"MSH|^~\&|REG|HUMC_EGATE@1||HUMC|20130528073829||ADT^A17|14150278|P|2.3|
...
ZCQ|1|1|CE|HOME^HOMELESS?|280005055^NH^NOT HOMELESS|||";
        ...
        static public readonly string VersionlessMessage = @"MSH|^~\&||P1SDEV|||20140522103041||ADT^A60||P||
