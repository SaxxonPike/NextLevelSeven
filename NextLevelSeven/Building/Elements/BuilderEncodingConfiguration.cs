...
namespace NextLevelSeven.Building.Elements
{
    ...
    internal sealed class BuilderEncodingConfiguration : EncodingConfiguration, IEncoding
    {
        ...
        char IEncoding.ComponentDelimiter
        {
            get
            {
                return Builder.ComponentDelimiter;
            }
            set
            {
                Builder.ComponentDelimiter = value;
            }
        }
        ...
        char IEncoding.EscapeCharacter
        {
            get
            {
                return Builder.EscapeCharacter;
            }
            set
            {
                Builder.EscapeCharacter = value;
            }
        }
        ...
        char IEncoding.FieldDelimiter
        {
            get
            {
                return Builder.FieldDelimiter;
            }
            set
            {
                Builder.FieldDelimiter = value;
            }
        }
        ...
        char IEncoding.RepetitionDelimiter
        {
            get
            {
                return Builder.RepetitionDelimiter;
            }
            set
            {
                Builder.RepetitionDelimiter = value;
            }
        }
        ...
        char IEncoding.SubcomponentDelimiter
        {
            get
            {
                return Builder.SubcomponentDelimiter;
            }
            set
            {
                Builder.SubcomponentDelimiter = value;
            }
        }
