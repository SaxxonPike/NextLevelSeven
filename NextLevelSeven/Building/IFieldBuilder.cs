...
{
    /// <summary>
    ///     Interface for a field element builder.
    /// </summary>
    public interface IFieldBuilder : IBuilder, IField
    {
        /// <summary>
        ...
        /// <returns>This IFieldBuilder, for chaining purposes.</returns>
        IFieldBuilder SetSubcomponents(int repetition, int componentIndex, int startIndex,
