namespace NextLevelSeven.Utility
{
    ...
    /// <summary>Represents a proxy that is a factory.</summary>
    /// <typeparam name="TOutput">Output type.</typeparam>
    ...
    /// <summary>Represents a proxy that gets a property using an index.</summary>
    ...
    /// <summary>Represents a proxy that sets a property using an index.</summary>
    /// <typeparam name="TKey">Type of key.</typeparam>
    /// <typeparam name="TValue">Type of value.</typeparam>
    /// <param name="value">New value.</param>
    internal delegate void ProxySetter<in TKey, in TValue>(TKey index, TValue value);

    /// <summary>Represents a proxy that sets a property.</summary>
    /// <typeparam name="TValue">Type of value.</typeparam>
    /// <param name="value">New value.</param>
