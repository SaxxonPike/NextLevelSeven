namespace NextLevelSeven.Core.Encoding
{
    ...
    internal abstract class EncodingConfigurationBase
    {
        ...
        ///     Get the delimiter character used to split components.
        /// </summary>
        public string ComponentDelimiterString { get { return new string(ComponentDelimiter, 1); } }
        ...
        ///     Get the escape character used to mark encoded sequences.
        /// </summary>
        public string EscapeDelimiterString { get { return new string(EscapeDelimiter, 1); } }
        ...
        ///     Get the escape character used to separate fields.
        /// </summary>
        public string FieldDelimiterString { get { return new string(FieldDelimiter, 1); } }
        ...
        ///     Get the repetition character used to separate multiple data in the same field.
        /// </summary>
        public string RepetitionDelimiterString { get { return new string(RepetitionDelimiter, 1); } }

        /// <summary>
        ///     Get the segment delimiter used to separate segments in a message. This is non-negotiable in the HL7 standard.
        /// </summary>
        public char SegmentDelimiter { get { return '\xD'; } }

        /// <summary>
        ///     Get the segment delimiter used to separate segments in a message. This is non-negotiable in the HL7 standard.
        /// </summary>
        public string SegmentDelimiterString { get { return "\xD"; } }
        ...
        ///     Get the delimiter character used to split subcomponents.
        /// </summary>
        public string SubcomponentDelimiterString { get { return new string(SubcomponentDelimiter, 1); } }
