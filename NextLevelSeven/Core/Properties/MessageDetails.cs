...
namespace NextLevelSeven.Core.Properties
{
    ...
    internal sealed class MessageDetails : IMessageDetails
    {
        ...
        public string ControlId
        {
            get
            {
                return _message[1][10].Value;
            }
            set
            {
                _message[1][10].Value = value;
            }
        }
        ...
        public string ProcessingId
        {
            get
            {
                return _message[1][11].Value;
            }
            set
            {
                _message[1][11].Value = value;
            }
        }
        ...
        public IIdentity Receiver
        {
            get
            {
                return new ProxyIdentity(_message[1], 5, 6);
            }
        }
        ...
        public string Security
        {
            get
            {
                return _message[1][8].Value;
            }
            set
            {
                _message[1][8].Value = value;
            }
        }
        ...
        public IIdentity Sender
        {
            get
            {
                return new ProxyIdentity(_message[1], 3, 4);
            }
        }
        ...
        public DateTimeOffset? Time
        {
            get
            {
                return _message[1][7].Codec.AsDateTime;
            }
            set
            {
                _message[1][7].Codec.AsDateTime = value;
            }
        }
        ...
        public string TriggerEvent
        {
            get
            {
                return _message[1][9][1][2].Value;
            }
            set
            {
                _message[1][9][1][2].Value = value;
            }
        }
        ...
        public string Type
        {
            get
            {
                return _message[1][9][1][1].Value;
            }
            set
            {
                _message[1][9][1][1].Value = value;
            }
        }
        ...
        public string Version
        {
            get
            {
                return _message[1][12].Value;
            }
            set
            {
                _message[1][12].Value = value;
            }
        }
    }
}