...
{
    /// <summary>
    ///     Wraps message details around a message.
    /// </summary>
    internal sealed class MessageDetails : IMessageDetails
    {
        /// <summary>
        ///     Message to wrap properties around.
        /// </summary>
        private readonly IMessage _message;

        /// <summary>
        ///     Create a message detail wrapper for a message.
        /// </summary>
        ...
        /// <summary>
        ///     Get or set the HL7 version number. If it does not exist, returns null.
        /// </summary>
