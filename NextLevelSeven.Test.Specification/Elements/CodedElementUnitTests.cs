...
{
    [TestClass]
    public class CodedElementUnitTests : SpecificationTestFixture
    {
        ...
        {
            _identifier = Mock.String();
            _text = Mock.String();
            _codingSystemName = Mock.String();
            _alternateIdentifier = Mock.String();
            _alternateText = Mock.String();
            _alternateCodingSystemName = Mock.String();
