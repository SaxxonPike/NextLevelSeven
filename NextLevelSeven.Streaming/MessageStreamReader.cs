...
namespace NextLevelSeven.Streaming
{
    ...
    public class MessageStreamReader : StreamWrapperBase, IMessageReader
    {
        ...
        public MessageStreamReader(Stream baseStream) : base(baseStream)
        {
        }
        ...
        /// <summary>
        ///     Read all messages in the stream. If empty, there were no more messages. (Using the base stream reader, the entire
