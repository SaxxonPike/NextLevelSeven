...
{
    /// <summary>A writer that wraps messages in MLP format.</summary>
    public class MlpStreamWriter : MessageStreamWriter
    {
        /// <summary>Create an MLP stream writer that uses the specified stream as a destination.</summary>
        /// <param name="baseStream">Stream to write to.</param>
        public MlpStreamWriter(Stream baseStream)
            : base(baseStream)
        {
        }

        /// <summary>Wrap raw data in an MLP packet.</summary>
